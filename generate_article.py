...
def generate_article():
    ...
    # Use a template with placeholders, then .format()
    html_template = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
        <div class="article">
            ...
            <div style="margin-top: 20px; font-family: Georgia, serif; line-height: 1.7;">
                <p>This is a sample article content for {topic}. Full text will be generated by AI later.</p>
            </div>
        </div>
    </div>
    <div class="footer">
    ...
    html_content = html_template.format(topic=topic, date_str=date_str)
